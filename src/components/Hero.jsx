...
const Hero = () => {
  ...
  return (
    <div className='w-full  transition-all duration-600 ease-in-out flex flex-col items-center lg:justify-center xl:px-[9%] px-4'>
        <div className=' lg:mx-auto sm:border-x sm:border-gray-200'>
